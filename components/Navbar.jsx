      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between gap-4 relative">
          ...
          <div className="logo flex-1 min-w-fit">
            <h1 className={`text-2xl md:text-3xl font-bold tracking-wide transition-colors duration-500 ${scrolled ? 'text-yellow-400' : 'text-white'}`}>Ingin Menjadi Programmer Handal Namun Malas Ngoding</h1>
          </div>
