  ...
  return (
    <section id="faq" className="py-20 bg-slate-50">
      <div className="container mx-auto px-4 max-w-3xl">
        <h3 className="text-3xl md:text-4xl font-bold text-slate-800 mb-10 text-center">FAQ</h3>
        <div className="space-y-6">
          {faqs.map((faq, idx) => (
            <div key={idx} className="border rounded-xl bg-white shadow-sm overflow-hidden">
              <button
