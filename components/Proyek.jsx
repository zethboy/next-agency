...
const Proyek = () => {
  return (
    <section id="proyek" className="py-20 bg-[#FAF6F0] w-full">
      <div className="max-w-7xl mx-auto px-6">
        <h3 className="text-2xl md:text-3xl font-bold text-[#8B0000] mb-10 text-center tracking-tight">Proyek Kami</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, idx) => (
            <div key={idx} className="bg-white rounded-xl shadow overflow-hidden hover:shadow-lg transition flex flex-col text-base">
