...
const AboutUs = () => {
  return (
    <section id="tentang-kami" className="about-us py-20 bg-white w-full">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1">
          <h3 className="text-2xl md:text-3xl font-bold text-slate-800 mb-4 tracking-tight">Tentang Kami</h3>
          <p className="text-base text-slate-600 mb-5 max-w-xl">
